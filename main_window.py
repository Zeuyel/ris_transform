...
from PyQt5.QtCore import Qt, QPropertyAnimation, QSize, QThread, pyqtSignal
from PyQt5.QtGui import QPalette, QColor, QFont, QPainter, QPen, QBrush, QIcon
import os
import sys
from script import process_ris_file  # 假设您的主要处理函数改名为 process_ris_file
import json
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 设置应用图标
        icon_path = get_resource_path("filter.ico")
        ...
        # 添加分类标准复选框
        self.checkboxes = {}
        criteria_list = ['top', '1a', 'abs3+', 'fmsB+', 'ccfA', 'ccfB', 'ccfC']
